                      ...
                      $.each(data, function(i, dato){
                        ...
                        if(dato['Estado']==1){ //Cambios aporbados
                            ...
                            tb5.row.add( [
                                  ...
                                  '<td style=""><div style="'+estilo+'">'+dato['CodigosU']+'<br><label><input type="checkbox" value="'+dato['CodigosU']+'" name="CodigosU[]"><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="'+estilo1+'">'+dato.modalidad['Nombre']+'<br><label><input type="checkbox" value="'+dato.modalidad['Id']+'" name="Nombre_m[]" ><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="'+estilo2+'">'+dato.tipocontrato['Nombre']+'<br><label><input type="checkbox" value="'+dato.tipocontrato['Id']+'" name="Nombre_t[]"><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="'+estilo3+'"><div class="campoArea">'+dato['ObjetoContractual']+'</div><br><label><input type="checkbox" value="'+dato['ObjetoContractual']+'" name="ObjetoContractual[]"><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="'+estilo5+'">'+dato['ValorEstimado']+'<br><label><input type="checkbox" value="'+dato['ValorEstimado']+'" name="ValorEstimado[]"><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="'+estilo6+'">'+dato['ValorEstimadoVigencia']+'<br><label><input type="checkbox" value="'+dato['ValorEstimadoVigencia']+'" name="ValorEstimadoVigencia[]"><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="'+estilo7+'">'+dato['VigenciaFutura']+'<br><label><input type="checkbox" value="'+dato['VigenciaFutura']+'" name="VigenciaFutura[]"><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="'+estilo8+'">'+dato['EstadoVigenciaFutura']+'<br><label><input type="checkbox" value="'+dato['EstadoVigenciaFutura']+'" name="EstadoVigenciaFutura[]"><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="'+estilo9+'">'+dato['FechaEstudioConveniencia']+'<br><label><input type="checkbox" value="'+dato['FechaEstudioConveniencia']+'" name="FechaEstudioConveniencia[]"><span><span></span></span></label>Selecionar</div></td>',
                                  ...
                                  '<td><div style="">'+nom_pro_rubr+'<br><label><input type="checkbox" value="'+id_p_r+'" name="Nombre_r[]"><span><span></span></span></label>Selecionar</div></td>',
                                  '<td><div style="">'+nom_meta+'<br><label><input type="checkbox" value="'+dato.meta['Id']+'" name="Meta_r[]"><span><span></span></span></label>Selecionar</div></td>',
                              ] ).draw( false );
                          num1++;
                        }
                      });
