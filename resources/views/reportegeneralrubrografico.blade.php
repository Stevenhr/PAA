...
@section('script')
	@parent
    <script src="{{ asset('public/Js/PAA/reporteGeneralRubro.js?n=1') }}"></script>	
@stop

@section('content')          
    <div class="content">
    	<div class="content" id="main_reporte" class="row" data-url="reporteRubroGrafico" ></div>
    	...
    	<form id="form_reporte_proyecto" method="post">
	    	<div class="row">
	    		...
	    		<div class="col-xs-12 col-md-4">
			    	<div class="form-group">	
					    <label for="proyecto">3. Rubro de funcionamiento</label>
