...
class ControllerReporteRubro extends Controller
{
    public function index()
    {
        ...
        return view('reportegeneralrubro',$datos);
    }
    ...
    public function validar_form(Request $request)
    {
        $validator = Validator::make($request->all(),
           ...
           else
           {
                    ...
                    $finanzas_r = Paa::with(['rubro_funcionamiento' => function($query)
                    {
